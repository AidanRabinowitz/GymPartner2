      ...
      <View style={{marginTop: 90, marginHorizontal: 20}}>
        ...
        <View style={{marginTop: 30, flexDirection: 'column', gap: 12}}>
          <View
            ...
            <Text style={{fontWeight: '500', fontSize: 15, color: 'black' }}>Standard</Text>
          ...
          <View
            ...
            <Text style={{fontWeight: '500', fontSize: 15, color: 'black'}}>Crossfit</Text>
          ...
          <View
            ...
            <Text style={{fontWeight: '500', fontSize: 15, color: 'black'}}>Rock Climbing</Text>
          ...
          <View
            ...
            <Text style={{fontWeight: '500', fontSize: 15, color: 'black'}}>Bisexual</Text>
