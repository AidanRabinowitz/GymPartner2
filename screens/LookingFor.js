      ...
      <View style={{marginTop: 90, marginHorizontal: 20}}>
        ...
        <View style={{marginTop: 30, flexDirection: 'column', gap: 12}}>
          <View
            ...
            <Text style={{fontWeight: '500', fontSize: 15, color: 'black'}}>Life Partner</Text>
          ...
          <View
            ...
            <Text style={{fontWeight: '500', fontSize: 15, color: 'black'}}>Long-term relationship</Text>
          ...
          <View
            ...
            <Text style={{fontWeight: '500', fontSize: 15, color: 'black', color: 'black'}}>Long-term relationship open to short</Text>
          ...
          <View
            ...
            <Text style={{fontWeight: '500', fontSize: 15, color: 'black', color: 'black'}}>Short-term relationship open to long</Text>
          ...
          <View
            ...
            <Text style={{fontWeight: '500', fontSize: 15, color: 'black'}}>Short-term relationship</Text>
          ...
          <View
            ...
            <Text style={{fontWeight: '500', fontSize: 15, color: 'black'}}>Figuring out my dating goals</Text>
        ...
        <View
          ...
          <Text style={{fontSize: 15, color: 'black'}}>Visible on profile</Text>
        </View>
        <TouchableOpacity
          onPress={handleNext}
          activeOpacity={0.8}
