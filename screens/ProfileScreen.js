    ...
    <SafeAreaView style={{flex: 1, backgroundColor: 'white'}}>
      ...
      <View style={{marginTop: 30, marginHorizontal: 20}}>
        <Image
          ...
          source={{
            uri: 'https://media.gettyimages.com/id/200404130-005/photo/young-man-about-to-lift-weight-in-gym.jpg?s=612x612&w=0&k=20&c=3bc5UxvA4i-Nmaf4SHqzDBhI2YBa28aAa_cG9O_Am38=',
          }}
        />
      </View>
      ...
      onPress={logout}
        ...
        <Text style={{textAlign:"center",fontWeight:"500", color: 'black'}}>Logout</Text>
      </Pressable>
    </SafeAreaView>
  );
};
