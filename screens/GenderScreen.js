      ...
      <View style={{marginTop: 90, marginHorizontal: 20}}>
        ...
        <View style={{marginTop: 30}}>
          <View
            ...
            <Text style={{fontWeight: '500', fontSize: 15, color: 'black'}}>Men</Text>
          ...
          <View
            ...
            <Text style={{fontWeight: '500', fontSize: 15, color: 'black'}}>Women</Text>
          ...
          <View
            ...
            <Text style={{fontWeight: '500', fontSize: 15, color: 'black'}}>Non-binary</Text>
        ...
        <View
          ...
          <Text style={{fontSize: 15, color: 'gray',}}>Visible on profile</Text>
        </View>
        <TouchableOpacity
        onPress={handleNext}
          activeOpacity={0.8}
